...
runtime_dir="$project_dir/run/m2"
frames=${1:-600}
server_pid=
socket_name="touchbar-m2-$$"
...
env XDG_RUNTIME_DIR="$runtime_dir" \
    ...
    --socket "$socket_name" --exit-after-client \
...
rg -q "renderer=Apple M1 .* transport=dmabuf" "$runtime_dir/client.log"
...
rg -q "releases=$frames" "$runtime_dir/touchbar-sessiond.log"
