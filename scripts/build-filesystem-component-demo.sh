...
guest_wasm="$project_dir/target/wasm32-wasip2/release/touchbar_filesystem_component_demo.wasm"
package_dir="$project_dir/target/filesystem-component-demo"
...
cargo build --release --target wasm32-wasip2 \
    ...
    -p touchbar-filesystem-component-demo
mkdir -p "$package_dir/component"
install -m 0644 "$guest_wasm" "$package_dir/component/plugin.wasm"
install -m 0644 "$project_dir/examples/filesystem-component-plugin/touchbar-plugin.toml" \
